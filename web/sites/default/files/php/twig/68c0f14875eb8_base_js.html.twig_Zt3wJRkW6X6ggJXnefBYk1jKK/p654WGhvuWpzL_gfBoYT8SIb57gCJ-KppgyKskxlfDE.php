...
class __TwigTemplate_d668a4bd6fc1a335861e7efab35eaf41 extends Template
{
      ...
      ";
        ...
        window.fetch = function () {
          ...
          if (!url.match(new RegExp(";
            // line 312
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(json_encode(($context["excluded_ajax_paths"] ?? null)));
            yield "))) {
            var method = 'GET';
      ...
      if (window.XMLHttpRequest && XMLHttpRequest.prototype.addEventListener) {
        ...
        XMLHttpRequest.prototype.open = function(method, url, async, user, pass) {
          ...
          if (url.substr(0, 1) === '/') {
            if (0 === url.indexOf('";
            // line 355
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, true, 355), "js"), "html", null, true);
            yield "')) {
              path = url.substr(";
            // line 356
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, true, 356)), "html", null, true);
            yield ");
            }
          }
          else if (0 === url.indexOf('";
            // line 359
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, (CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "schemeAndHttpHost", [], "any", false, false, true, 359) . CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, true, 359)), "js"), "html", null, true);
            yield "')) {
            path = url.substr(";
            // line 360
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, Twig\Extension\CoreExtension::length($this->env->getCharset(), (CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "schemeAndHttpHost", [], "any", false, false, true, 360) . CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, true, 360))), "html", null, true);
            yield ");
          }
      ...
      return {
        ...
        yield "'.replace(/xxxxxx/, newToken),
            function(xhr, el) {
              ...
              renderAjaxRequests();
              var ajaxInfo = document.querySelector('.sf-toolbar-block-ajax .sf-toolbar-info');
              if(null !== ajaxInfo) {
...
";
    ...
    {
        return array (  717 => 640,  628 => 554,  464 => 392,  432 => 363,  426 => 360,  422 => 359,  416 => 356,  412 => 355,  366 => 312,  345 => 293,  343 => 292,  56 => 7,  47 => 3,);
    }
